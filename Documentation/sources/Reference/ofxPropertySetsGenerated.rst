...
- :ref:`OfxImageEffectPropCudaRenderSupported <prop_OfxImageEffectPropCudaRenderSupported>` - Type: enum, Dimension: 1 (doc: :c:macro:`kOfxImageEffectPropCudaRenderSupported`)
- :ref:`OfxImageEffectPropCudaStreamSupported <prop_OfxImageEffectPropCudaStreamSupported>` - Type: enum, Dimension: 1 (doc: :c:macro:`kOfxImageEffectPropCudaStreamSupported`)
- :ref:`OfxImageEffectPropMetalRenderSupported <prop_OfxImageEffectPropMetalRenderSupported>` - Type: enum, Dimension: 1 (doc: :c:macro:`kOfxImageEffectPropMetalRenderSupported`)
...
- :ref:`OfxImageEffectPropOpenCLRenderSupported <prop_OfxImageEffectPropOpenCLRenderSupported>` - Type: enum, Dimension: 1 (doc: :c:macro:`kOfxImageEffectPropOpenCLRenderSupported`)
