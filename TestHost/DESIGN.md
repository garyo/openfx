...
- The render-action `@actiondef` lacks the render window, render scale and
  field properties until PR #263 lands; the host defines those three
  explicitly, with a comment to remove once the metadata has them.
